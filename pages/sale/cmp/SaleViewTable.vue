<template>
  <div class="sale-view-table">
    <qf-table :data="bill.lines" row-key="id" showSummary :summary-method="getSummaries">
      ...
      <qf-table-column label="原价(含税)" prop="salePrice" :formatter="priceFormatter" align="right"></qf-table-column>
      <qf-table-column label="优惠" prop="favAmount" :formatter="priceFormatter" align="right"></qf-table-column>
