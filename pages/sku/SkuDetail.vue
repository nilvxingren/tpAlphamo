<template>
  <page-body :menu="menu" class="sku-detail">
    ...
    <!--根据列表页面传递的字段或后台返回的字段来控制显示一般商品信息还是配方商品信息-->
    <!--一般商品界面-->
    <div class="content" v-if="sku.type === 'NORMAL'">
      <qf-row class="marginTop12">
        <qf-col :span="6">
          <div class="info" text-align="right">基本信息</div>
        </qf-col>
        <qf-col :span="18">
          <qf-row class="marginTop12">
            <qf-col :span="12">
              <qf-form-item label="商品类型:">
                <!--<p class="sku-name" :title="sku.type">{{sku.type}}</p>-->
                <p class="sku-name">一般商品</p>
              </qf-form-item>
            </qf-col>
            <qf-col :span="12">
              <qf-form-item><p class="sku-name"></p></qf-form-item>
            </qf-col>
          </qf-row>
          <qf-row>
            <qf-col>
          ...
          <qf-row>
            <qf-col>
              <qf-form-item label="商品编号:">{{sku.code}}</qf-form-item>
            </qf-col>
            <qf-col>
          ...
          <qf-row>
            <qf-col>
              <qf-form-item label="分类:">{{sku.category.name}}</qf-form-item>
            </qf-col>
            <qf-col>
          ...
          <qf-row>
            <qf-col>
              <qf-form-item label="规格:">{{sku.qpc}}</qf-form-item>
            </qf-col>
            <qf-col>
          ...
          <qf-row>
            <qf-col>
              <qf-form-item label="品牌:">{{sku.brand}}</qf-form-item>
            </qf-col>
            <qf-col>
          ...
          <qf-row>
            <qf-col>
              <qf-form-item label="采购组:">{{sku.purchaseGroup}}</qf-form-item>
            </qf-col>
            <qf-col>
          ...
          <qf-row>
            <qf-col>
              <qf-form-item label="进项税率:">{{sku.inputTaxRate | taxRateFormatter}}</qf-form-item>
            </qf-col>
            <qf-col>
          ...
          <qf-row>
            <qf-col>
              <qf-form-item label="税收分类编码:">{{sku.taxClassification}}</qf-form-item>
            </qf-col>
            <qf-col>
      ...
      <qf-row class="marginTop40">
        <qf-col :span="6">
          <div class="price" text-align="right">配方单位设置</div>
        </qf-col>
        <qf-col :span="9">
          <!--绑定后台返回数据-->
        ...
        <qf-col :span="9"></qf-col>
      </qf-row>
      <qf-row class="marginTop40">
        <qf-col :span="6">
          <qf-row>
            <div class="price" text-align="right">价格信息</div>
          </qf-row>
        </qf-col>
        <qf-col :span="18">
          <qf-row>
          ...
          <qf-row>
            <qf-col :span="12">
              <qf-form-item label="零售价(含税):" style="width: auto">
                {{sku.salePrice | fmt}}
              </qf-form-item>
            </qf-col>
            <qf-col :span="12">
              <qf-form-item label="最低售价(含税):" class="width:40px">
                {{sku.minSalePrice | fmt}}
              </qf-form-item>
            </qf-col>
          </qf-row>
        </qf-col>
    ...
    <div class="content" v-if="sku.type !== 'NORMAL'">
      ...
      <qf-row class="marginTop40">
        <qf-col :span="6">
          <div class="price" text-align="right">配方信息</div>
        </qf-col>
        <qf-col :span="18">
          <qf-row>
            <qf-col>
              <qf-form-item label="成品单位:">中杯</qf-form-item><!--{{sku.name}}绑定后台返回字段-->
            </qf-col>
            <qf-col>
              <div style="color: blue;cursor: pointer" @click="checkInfo">配方信息修改记录</div>
            </qf-col>
          </qf-row>
          <qf-row>
            <qf-col :span="24">
      ...
      <qf-row class="marginTop40">
        <qf-col :span="6">
          <div class="info" text-align="right">价格信息</div>
        </qf-col>
        <qf-col :span="18">
          <qf-row class="marginTop12">
            <qf-col :span="12">
